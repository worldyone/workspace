    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == MOUSEBUTTONDOWN and event.button == 1:
                xpos, ypos = floor(
                    event.pos[0] / SIZE), floor(event.pos[1] / SIZE)
            ...
            for xpos in range(WIDTH):
                ...
                if tile == EMPTY or tile == BOMB:
                    ...
                    if count > 0:
                        ...
                        SURFACE.blit(
                            num_image, (xpos * SIZE + 10, ypos * SIZE + 10))

        # 線の描画
        for index in range(0, WIDTH * SIZE, SIZE):
            pygame.draw.line(
                SURFACE, (96, 96, 96), (index, 0), (index, HEIGHT * SIZE))
        for index in range(0, HEIGHT * SIZE, SIZE):
            pygame.draw.line(
                SURFACE, (96, 96, 96), (0, index), (WIDTH * SIZE, index))
